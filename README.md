...
[SpikeStereoNet: A Brain-Inspired Framework for Stereo Depth Estimation from Spike Streams](https://openreview.net/pdf?id=lPMPFeioCZ)<br/>
...
## Required Data
To evaluate/train SpikeStereoNet, you will need to download the required datasets from [Hugging Face](https://huggingface.co/datasets/gzh0814/SpikeStereoNet/tree/main).
...
$\text{depth} = \dfrac{\text{focal length} \times \text{baseline}}{|\text{disparity} + (c_{x1} - c_{x0})|}$
